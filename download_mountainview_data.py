"""
download_mountainview_data.py

Downloads the daily Plant Report XLSX for Mountain View Shopping Centre (Gordons Bay) from the
FusionSolar portal via Playwright.

SITE CONFIG — edit these if the plant name in the FusionSolar portal changes:
  Search term (typed into the Plant name search box): 'Mountain View'
  Plant link text to click:                           'Mountain View shopping centre Gordons bay'
  Output file:                                        data/mountainview_raw.xlsx
...
def download_mountainview_data():
    """Download Mountain View Shopping Centre (Gordons Bay) data from FusionSolar"""

    print("🚀 Starting Mountain View Shopping Centre (Gordons Bay) data download...")
    ...
    with sync_playwright() as playwright:
        ...
        try:
            ...
            # =========================================================
            # Step 6: Search for Mountain View
            # Try multiple selector strategies based on inspection
            # =========================================================
            print("🔎 Step 6: Searching for Mountain View...")
            ...
            human_delay(1, 2)
            type_human_like(search_field, "Mountain View")
            human_delay(2, 3)
            ...
            # =========================================================
            # Step 7: Click Mountain View
            # =========================================================
            print("🏢 Step 7: Selecting Mountain View shopping centre Gordons bay...")
            try:
                page.get_by_role("link", name="Mountain View shopping centre Gordons bay").click()
            except:
                # Fallback: find by text
                page.get_by_text("Mountain View shopping centre Gordons bay").first.click()

            page.wait_for_load_state("networkidle", timeout=60000)
            human_delay(5, 8)
            random_mouse_movement(page)

            page.screenshot(path="04_mountainview_station.png", full_page=True)
            ...
            download_path = data_dir / "mountainview_raw.xlsx"
